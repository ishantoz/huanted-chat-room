  ...
  return (
    ...
    >
      <div className="sm:py-3.5 py-2.5 flex items-center relative justify-center">
        <h1 className="sm:text-lg text-orange-500 flex items-center gap-1 font-semibold font-matal tracking-widest">
          ...
          >
            <div>
              {user.uuid === member.uuid ? (
                <h3 className="text-blue-500 font-matal tracking-widest font-semibold cursor-pointer hover:underline">
                  You ({member.username})
                </h3>
              ) : (
                <h3 className="text-neutral-200 font-matal tracking-widest font-semibold cursor-pointer hover:underline">
                  {member.username}
                </h3>
              )}
